import { QuizWord, VocabularyRow,CategoryRow } from './types';

export const mockQuizData: QuizWord[] =
  [
    {
      "id": 9936,
      "vocabulary": 1001,
...
export const mockVocabularyData: VocabularyRow = {
  "id": 1001,
  "index": 1,
  "category": 10,
  "categoryID": 10,
  ...
  "countPhrases": 0,
  "countDone": 0,
  "vItems": [9936, 9937, 9938, 9939, 9940, 9941, 9942, 9943, 9944, 9945]
}

export const mockCategoryData: CategoryRow = {
  "id": 10,
  "customIndex": 0,
  "progressType": 1,
  "uiModifiers": "{\"learningUnitNamesAndIndex\":true,\"vocabularyRecapSubtitle\":true}",
  "modifiers": null,
  "name": "‫المواصلات العامة",
  "countLesson": 6,
  "countDialogue": 1,
  "countVocabulary": 1,
  "countOxfordtest": 0,
  ...
  "countDone": 6,
  "time": 5455.29,
  "lessons": "{1001,1002,1003,1004,1005,1006}",
  "dialogues": "{1001}",
  "vocabularies": "{1001}",
  "oxfordTests": "{}",
  "reviewLessons": "{}"
