...
export function VocsTable({ vocs }: VocsTableProps) {
 ...
 return (
   <Table className="w-full border text-md sm:text-lg bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white">
      <TableHeader className="bg-green-100 rounded-xl">
        <TableRow className="">
          ...
          <TableHead className="flex items-center gap-4 justify-end w-full">
            ...
            <Button onClick={toggleTargetFont}>Naskh</Button>
          </TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
          ...
          <TableRow key={voc.id}>
            ...
            <TableCell className="text-center">
              {/* <AudioPlayer
                ...
                autoPlay={false}
              /> */}
              <TonePlayerButton url={getAudioUrl(voc.key)} />
            </TableCell>
            <TableCell className="text-center">
