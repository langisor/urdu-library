...
import { convertQb } from "../converters";
...
export default function QuizQb({ quiz, quizzerFeedback }: QuizQbProps) {
  ...
  const selectectedOption = useHookstate("");
  ...
  const actions = {
    checkAnswer: () => {
      ...
      if (selectectedOption.get() === currentQuestion.correctAnswerId.get()) {
        playCorrectTune();
        // add score
  ...
  return (
    <div className="flex flex-col  text-right" dir="rtl">
      ...
      <Card className="h-full">
        ...
        <CardContent>
          <RadioGroup
            ...
            dir="rtl"
            onValueChange={(value) =>  selectectedOption.set( value)}
            value={selectectedOption.get()}
          >
              ...
              >
                <CardAction
                  className="w-full h-full"
                   onClick={() => selectectedOption.set(option.id.get())}
                >
      ...
      <Card>
        <CardContent>
          <Button
            disabled={selectectedOption.get() === ""}
