...
export const Chapter3 = ({
  ...
  return (
    <div className="container">
      ...
      <h3>
        1. Components of a Sentence (جملے کے اجزاء - <em>Jumlay ke Ajza</em>)
      </h3>
      <p>
      ...
      <ul>
        <li>
          <strong>
            Subject (فاعل - <em>Faa'il</em>):
          </strong>{" "}
          This is the person, place, thing, or concept that performs the action
          or about which something is stated. It usually comes first.
          <ul>
            <li>
              Example:
              <span className="urdu-text">لڑکا</span>(<em>Larka</em> - The boy),
              <span className="urdu-text">کتا</span>(<em>Kutta</em> - The dog),
              <span className="urdu-text">وہ کتاب</span>(<em>Woh kitaab</em> -
              That book),
              <span className="urdu-text">ہم</span>(<em>Hum</em> - We).
            </li>
          </ul>
        </li>
        <li>
          <strong>
            Predicate (خبر - <em>Khabar</em>):
          </strong>{" "}
          This is the part of the sentence that contains the verb and provides
          information about the subject. In Urdu, the verb typically comes at
          ...
          <ul>
            <li>
              ...
              <span className="urdu-text">پرانی ہے۔</span>(<em>Purani hai.</em>{" "}
              - Is old.).
            </li>
          </ul>
        </li>
      ...
      <h3>
        2. Basic Sentence Patterns (بنیادی جملے کے نمونے -{" "}
        <em>Buniyadi Jumlay ke Namoonay</em>)
      </h3>
      <p>
      ...
      <ul>
        <li>
          <strong>
            Declarative Sentences (خبری جملے - <em>Khabari Jumlay</em>):
          </strong>
          Make a statement.
          <ul>
            <li>
        ...
        <li>
          <strong>
            Interrogative Sentences (سوالیہ جملے - <em>Sawaliya Jumlay</em>):
          </strong>
          Ask a question. Often use
          <span className="urdu-text">کیا</span>(<em>kya</em> - what) at the
          beginning or an interrogative pronoun (who, where, when, why) within
          the sentence.
          <ul>
            <li>
              Example:
        ...
        <li>
          <strong>
            Negative Sentences (منفی جملے - <em>Manfi Jumlay</em>):
          </strong>
          Deny something. Use the particle
          <span className="urdu-text">نہیں</span>(<em>nahin</em> - not) before
          the verb.
          <ul>
            <li>
              Example:
        ...
        <li>
          <strong>
            Imperative Sentences (حکمیہ جملے - <em>Hukmiya Jumlay</em>):
          </strong>
          ...
          <ul>
            ...
            <li>
              Example (Informal):
              <span className="urdu-text">یہاں آؤ۔</span>(<em>Yahan aao.</em> -
              Come here.)
            </li>
          </ul>
        </li>
      ...
      <ul>
        <li>
          ...
          <span className="urdu-text">اور</span>(<em>aur</em> - and) or
          <span className="urdu-text">لیکن</span>(<em>lekin</em> - but).
          <ul>
            <li>
              Example:
              <span className="urdu-text">
                میں آیا اور اس نے مجھ سے بات کی۔
              </span>
        ...
        <li>
          <strong>Complex Sentences:</strong> One independent clause and at
          least one dependent (subordinate) clause, often introduced by words
          like
          <span className="urdu-text">جب</span>(<em>jab</em> - when),
          <span className="urdu-text">اگر</span>(<em>agar</em> - if),
          <span className="urdu-text">کیونکہ</span>(<em>kyunki</em> - because).
          <ul>
            <li>
              Example:
      ...
      <div className="quiz-container">
        ...
        <p>Test your understanding of Urdu sentence structure.</p>
        ...
        <div className="quiz-question">
          ...
          <span className="urdu-text">کھانا</span>(<em>khana</em> - to eat).
        </div>
        <div className="quiz-question">
          7. Complete the conditional:
          <span className="urdu-text">اگر وقت ہوتا، ...</span>(
          <em>Agar waqt hota, ...</em> - If there was time, ...) (Give a
          suitable result clause)
        </div>
        <div className="quiz-question">
          8. Add a relative clause to describe
          <span className="urdu-text">کتاب</span>(<em>kitaab</em> - book):
          <span className="urdu-text">میں نے کتاب خریدی۔</span>(
          <em>Main ne kitaab khareedi.</em> - I bought the book.) Use
          <span className="urdu-text">وہ</span>(<em>woh</em> - that) and
          <span className="urdu-text">پرانی</span>(<em>purani</em> - old).
        </div>
        <div className="quiz-answers">
          (Answers: 1. S:
          <span className="urdu-text">پرندہ</span>(<em>Parinda</em>), P:
          <span className="urdu-text">اُڑ رہا ہے۔</span>(<em>Urh raha hai.</em>
          ); 2.
          ...
          <span className="urdu-text">کھائیے۔</span>(<em>Khaiye.</em>); 7. ...
          <span className="urdu-text">تو میں آتا۔</span>
          (... <em>to main aata.</em> - ... then I would come.) OR ...
          <span className="urdu-text">تو ہم چلتے۔</span>
          (... <em>to hum chalte.</em> - ... then we would go.) (Any suitable
          unreal result); 8.
          <span className="urdu-text">
            میں نے وہ کتاب خریدی جو بہت پرانی تھی۔
          </span>
