...
export const Chapter6 = ({ navigateTo }: { navigateTo: (page: string) => void }) => {
 return (
  <div className="container">
    ...
    <ul>
      <li>
        <strong>Incorrect word order:</strong> Putting the verb in the middle of the
        sentence like in English.
      </li>
      <li>
    ...
    <p>
      Punctuation marks guide the reader and convey tone.
    </p>
    <ul>
      <li>
    ...
    <p>
      <strong>Note:</strong> While Urdu uses these marks, their use can be less
      rigid than in English, often relying more on context and syntax.
    </p>
    ...
    <p>
      Urdu is famous for its rich poetic tradition, with two main forms:
    </p>
    <ul>
      <li>
