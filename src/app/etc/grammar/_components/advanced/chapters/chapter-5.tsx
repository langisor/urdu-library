    ...
    <div className="container">
      ...
      <ul>
        ...
        <li>
          ...
          <span className="urdu-text">گھر</span>- <em>ghar</em> &rarr;
          <span className="urdu-text">گھر میں</span>- <em>ghar mein</em>) or a
          postposition. This is the primary mechanism for showing case.
        </li>
      </ul>

      <h3>
        2. Active and Passive Voice (
        <span className="urdu-text">صوتی حالت</span>- <em>Souti Haalat</em>)
      </h3>
      <ul>
        <li>
        ...
        <li>
          ...
          <span className="urdu-text">جانا</span>(<em>jaana</em> - to go) or
          <span className="urdu-text">ہونا</span>(<em>hona</em> - to be) used as
          an auxiliary verb.
          <br />
      ...
      <h3>
        ...
        <span className="urdu-text">بلاواسطہ اور بالواسطہ</span>-{" "}
      ...
      <h3>
        ...
        <span className="urdu-text">سابقے اور لاحقے</span>-{" "}
      ...
      <ul>
        <li>
          ...
          <br />
          <span className="urdu-text">بدقسمتی</span>(<em>bad-qismati</em> - bad
          luck) &larr;
          <span className="urdu-text">قسمت</span>(<em>qismat</em> - luck)
        </li>
        <li>
          <strong>بے-</strong> (<em>be-</em>): Means "without."
          <br />
          <span className="urdu-text">بےعزت</span>(<em>be-izzat</em> - without
          respect) &larr;
          <span className="urdu-text">عزت</span>(<em>izzat</em> - respect)
        </li>
        <li>
          <strong>نا-</strong> (<em>na-</em>): Means "not."
          <br />
          <span className="urdu-text">نااہل</span>(<em>na-a'hil</em> - not
          capable) &larr;
          <span className="urdu-text">اہل</span>(<em>a'hil</em> - capable)
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <br />
          <span className="urdu-text">پاکستانی</span>(<em>Pakistani</em>-
          Pakistani),
          <span className="urdu-text">دوستی</span>(<em>dosti</em> - Friendship),
          <span className="urdu-text">آسمانی</span>(<em>aasmani</em> - Heavenly)
        </li>
        <li>
          <strong>-گی</strong> (<em>-gi</em>): Forms abstract nouns.
          <br />
          <span className="urdu-text">چھوٹی</span>(<em>chhoti</em>- smallness),
          <span className="urdu-text">بڑی</span>(<em>bari</em>-
          bigness/elderness),
          <span className="urdu-text">جوانی</span>(<em>jawani</em>- youth)
        </li>
        <li>
          <strong>-انہ</strong> (<em>-ana</em>): Forms adverbs or adjectives
          meaning "in the manner of."
          <br />
          <span className="urdu-text">انسانانہ</span>(<em>insaanaana</em>-
          humanely),
          <span className="urdu-text">دوستانہ</span>(<em>dostaana</em>-
          friendly),
          <span className="urdu-text">شہزادیانہ</span>(<em>shehzadiaana</em>-
          princess-like)
        </li>
        <li>
          <strong>-دار</strong> (<em>-dar</em>): Possessor of, holder of.
          <br />
          <span className="urdu-text">ملک دار</span>(<em>mulk-dar</em>-
          landowner),
          <span className="urdu-text">عزت دار</span>(<em>izzat-dar</em>-
          respectable),
          <span className="urdu-text">عہدہ دار</span>(<em>ohda-dar</em>-
          officeholder)
        </li>
        <li>
          <strong>-ستان</strong> (<em>-stan</em>): Place of, land of.
          <br />
          <span className="urdu-text">پاکستان</span>(<em>Pakistan</em>- Land of
          the Pure),
          <span className="urdu-text">ہندوستان</span>(<em>Hindustan</em>- Land
          of Hindus),
          <span className="urdu-text">باغستان</span>(<em>baghistan</em>-
          orchard)
        </li>
      </ul>
      <h3>
      ...
      <ul>
        <li>
          <span className="urdu-text">کو</span>(<em>ko</em>): Used to mark the
          direct object of a transitive verb (for definite nouns) or the
          indirect object.
          <br />
          <span className="urdu-text">میں نے اس کو دیکھا۔</span>(
        ...
        <li>
          <span className="urdu-text">پر</span>(<em>par</em>): Means "on" or
          "at."
          <br />
        ...
        <li>
          <span className="urdu-text">سے</span>(<em>se</em>): A versatile
          postposition meaning "from," "with," "by," or "than."
          <br />
      ...
      <p>Emphasis is used to highlight a specific part of a sentence.</p>
      <ul>
        <li>
          <strong>Particles:</strong>
          <span className="urdu-text">ہی</span>(<em>hi</em>) and
          <span className="urdu-text">بھی</span>(<em>bhi</em>).
          <br />
          <span className="urdu-text">میں نے ہی کیا ہے۔</span>(
          <em>Main ne hi kiya hai.</em> - I<strong>myself</strong> did it.)
          <br />
          <span className="urdu-text">وہ بھی آیا۔</span>(<em>Woh bhi aaya.</em>{" "}
          - He came
          <strong>too</strong>.)
        </li>
        <li>
          <strong>Word Order:</strong> Moving a word to a less common position
          in the sentence.
        </li>
        <li>
      ...
      <div className="quiz-container">
        ...
        <div className="quiz-question">
          ...
          does the pronoun
          <span className="urdu-text">اس کو</span>(<em>us ko</em>) serve?
        </div>
        ...
        <ol className="quiz-options">
          <li>
            <span className="urdu-text">لکھنا</span>(<em>likhna</em> - to write)
          </li>
          <li>
            <span className="urdu-text">جانا</span>(<em>jaana</em> - to go)
          </li>
          <li>
            <span className="urdu-text">کرنا</span>(<em>karna</em> - to do)
          </li>
          <li>
            <span className="urdu-text">آنا</span>(<em>aana</em> - to come)
          </li>
        </ol>
        ...
        <div className="quiz-question">
          ...
          <em>Us ne kaha, "Main Lahore ja raha hoon."</em> - He said, "I am
          going to Lahore.")
        </div>
        <div className="quiz-question">
        ...
        <ol className="quiz-options">
          <li>
            <span className="urdu-text">بد-</span>(<em>bad-</em>)
          </li>
          <li>
            <span className="urdu-text">نا-</span>(<em>na-</em>)
          </li>
          <li>
            <span className="urdu-text">بے-</span>(<em>be-</em>)
          </li>
          <li>
            <span className="urdu-text">کم-</span>(<em>kam-</em>)
          </li>
        </ol>

        <div className="quiz-question">
          5. What is the meaning of the suffix
          <span className="urdu-text">-ستان</span>(<em>-stan</em>)?
        </div>
        <div className="quiz-question">
          6. In Urdu, the postposition
          <span className="urdu-text">سے</span>(<em>se</em>) is used to show a
          relationship. Give a sentence showing its use to mean "from."
        </div>
        <div className="quiz-question">
